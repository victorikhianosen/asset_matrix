        ...
        <div class="mx-6 md:mx-8 lg:mx-24 pb-1 pt-28 md:pb-10 md:pt-44">
            <div class="">
                   ...
                   <h1
                    ...
                    Anti-Money Laundering Policy</h1>
            </div>
        </div>
    </section>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            potential Money Laundering/Terrorist Financing (ML/TF) risks associated with specific customers
                            and transactions in order to ensure focused monitoring of t hose customers and transactions that
                            potentially pose the greatest risks of ML/TF.
                        ...
                        <p class="text-lg tracking-wider text-black"align="justify">
                            ...
                            of necessary controls such as the implementation of appropriate customer due diligence,
                            verification and monitoring procedures that are proportionate to the identified ML/FT risks that
                            the financial institution is exposed to from its customers, products and countries that it
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            MFB and its reputation from being misused for money laundering and/or terrorism financing by
                            ensuring they discharge their responsibilities in a manner that enables full implementation of
                            this AML/CFT Policy.
