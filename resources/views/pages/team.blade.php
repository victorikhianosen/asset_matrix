...
@section('main')
    ...
    <section class="pb-24">
        ...
        <div class="font-[sans-serif]">
            <div class="h-60 w-full bg-gradient-to-r from-yellow via-primary to-purple"></div>
            ...
            <div class="max-w-5xl max-md:max-w-xl max-sm:max-w-sm mx-auto -mt-48 px-6">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-12 max-sm:justify-center text-center">


                    <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
                        <div class="lg:min-h-[250px]">
                            <img class="bg-[#E9F2F8]" src="{{ asset('asset/images/ceo.jpg') }}"
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
                        <div class="lg:min-h-[250px]">
                            <img src="{{ asset('asset/images/ceo.jpg') }}" class="w-full rounded-lg inline-block" />
                        </div>
