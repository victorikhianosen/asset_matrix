...
@section('main')
    <section class="bg-gradient-to-r from-[#ee8520] to-[#ff6f00]">
        <div class="mx-6 md:mx-8 lg:mx-24 pb-1 pt-28 md:pb-10 md:pt-44 border-b-2 border-primary">
            <div class="">
                <h1
                    class="text-white text-star text-5xl md:text-6xl lg:text-4xl font-semibold gap-6 tracking-tighter leading-tight">
                    Our Team</h1>
            ...
            <div class="max-w-5xl max-md:max-w-xl max-sm:max-w-sm mx-auto -mt-48 px-6">
                ...
                <div class="font-[sans-serif]">
                    ...
                    <div
                        ...
                        <div>
                            <img src="{{ asset('asset/images/about22.png') }}" class="w-52 h-52 rounded-full inline-block" />
                        ...
                        <div>
                            <img src="{{ asset('asset/images/about22.jpg') }}" class="w-52 h-52 rounded-full inline-block" />
