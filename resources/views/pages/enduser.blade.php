    ...
    <section class="bg-white">
        <div class="mx-6 md:mx-8 lg:mx-24 py-10 md:py-24">
            <div class="container mx-auto p-6 space-y-12">
                <h2 class="text-2xl md:text-5xl text-black font-semibold">
                    <span class="text-primary">Agreement
                    </span> to Use Cash Matrix Mobile Banking Application
                </h2>
                <div class="space-y-6">
                    <h4 class="text-4xl">
                        <span><i class="fa-solid fa-circle text-primary mr-2"></i></span>
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            web and mobile, including all related technology provided by Cash Matrix (the Mobile
                            Application).
                        </p>

                        <div class="space-y-3">
                            <div class="flex items-start text-xs space-x-2 md:text-sm tracking-wider text-black">
                                <span>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            controlled by you, strictly in accordance with the Mobile Application’s documentation; and
                            access, download and use on such technology device, the Content and Services (as defined in
                            Clause 6) made available in or otherwise accessible through the Mobile Application, strictly in
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start text-xs space-x-2 md:text-sm tracking-wider text-black">
                                ...
                                <p align="justify">
                                    ...
                                    Application available on a network where it is capable of being accessed by more than
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            use the Mobile Application in accordance with the terms of this Agreement. You acknowledge that
                            you have no right to have access to the Mobile Application in source code form other than as
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            other intellectual property rights therein or relating thereto, except as expressly granted to
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            provide certain information about yourself as a condition to downloading, installing, or using
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            your acceptance of such Terms and Conditions and Privacy Policy and/or to register with the
                            Website, and your failure to do so may restrict you from accessing or using certain of the
                            Mobile Application’s features and functionality.
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            persons or in certain countries. If you access the Content and Services from outside Nigeria,
                            you are responsible for compliance with local laws. The Licensor will not be liable for your
                            access and use of the Contents and Services outside Nigeria
                        </p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            delete in their entirety certain features and functionality. You agree that Cash Matrix has no
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            liability or responsibility to you or any other person or entity for any Third-Party Materials.
                            Third-Party Materials and links thereto are provided solely as a convenience to you, and you
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            viruses or other contaminating or destructive properties will be transmitted or that no damage
                            will occur to your technology device..
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            mobile application, including all implied warranties of merchantability, fitness for a
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            errors or defects can or will be corrected. some jurisdictions do not allow the exclusion of or
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            damages in amounts that in the aggregate exceed the amount actually paid by you for the Mobile
                            Application.
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start text-xs space-x-2 md:text-sm tracking-wider text-black">
                                ...
                                <p>
                                    contact information [name, title, address, email address, mobile phone number etc, Date
                                    of birth];
                        ...
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            Mobile Application, for the prevention of money laundering, customer analysis, assessment, risk
                            analysis and management, business development, for commercial and marketing purposes and for
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-lg tracking-wider text-black" align="justify">
                            ...
                            attorneys’ fees, arising from or relating to your use or misuse of the Mobile Application or
