        ...
        <div class="mx-6 md:mx-8 lg:mx-24 py-10 md:py-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 justify-center items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 justify-center items-center gap-6 w-full lg:w-9/12 pt-0 lg:pt-4">
                                ...
                                <div
                                    ...
                                    <div>
                                        <p
                                            ...
                                            Downloadon on the</p>
                                        <h4 class="text-black group-hover:text-white text-sm md:text-lg">Google Play
                                        </h4>
                                    </div>
                                </div>
                            </a>
