        ...
        <div class="mx-6 md:mx-8 lg:mx-24 py-10 md:py-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 justify-center items-center">
                ...
                <div class="space-y-4 md:space-y-8">
                    <h1 class="text-3xl md:text-5xl leading-0 text-white font-semibold justify-start">
                        Explore Our Flexible Loan Products for Every Need
                    </h1>
                    <p class="text-xs md:text-sm tracking-wider text-white" align="justify">We make access to loans simple and
                        easy. No
                    ...
                    <div class="grid grid-cols-2 gap-y-4 md:gap-y-0">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-start items-baseline gap-2">
                                <span><i
                                        class="fa-solid fa-check bg-white text-sm rounded-full p-1 text-black border-2 border-black"></i></span>
                                <p class="text-md md:text-lg text-white tracking-wider">Educational Loan</p>
                            </div>
                        </div>
                    ...
                    <div>
                        <a href="{{ route('loan') }}"
                            class="bg-white mt-12 font-semibold py-2 px-10 rounded-full text-black border-2 border-white
