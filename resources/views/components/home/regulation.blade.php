        ...
        <div class=" space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center justify-center">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4 w-full" align='justify'>
                        <p class="text-xs md:text-sm tracking-wider text-black" align='justify'>
                            At Asset Matrix Microfinance Bank, we prioritize your financial security and peace of
                            mind.
                        ...
                        <p class="text-xs md:text-sm tracking-wider text-black" align='justify'>
                            ...
                            Additionally, your deposits are insured by the Nigeria Deposit Insurance
