...
<body class="">
    ...
    <section>
        <div class="mx-5 md:mx-8 md:my-16 lg:mx-24 py-8">
    ...
    <section class="bg-white">
        <div>
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="bg-black pl-5 lg:pl-24 pr-24 py-6 text-white space-y-8">
                    <h2
                        class="text-2xl text-white lg:text-4xl mt-8 md:pt-2 w-full lg:w-8/12 font-semibold tracking-tight leading-10">
                        Our Easy Step For POS
                        registration
                    </h2>

                    <div>
                        <p class="text-sm text-whiteText tracking-wide font-light">Lorem Ipsum is simply dummy text of
                            the printing and
                            typesetting
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-y-4 md:gap-y-2">
    ...
    <section>
        ...
        <div class="bg-white text-black space-y-8 py-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                ...
                <div class="space-y-6">
                    <h4 class="text-black text-4xl font-semibold w-9/12"><span class="text-primary">CashMatrix</span>
                        Is The Fastest Mobile Banking Solution</h4>
                    <p class="text-blackText">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sunt libero
                        ...
                        <a href=""
                            ...
                            <div>
                                <p class="text-xs text-whiteText group-hover:text-black font-light tracking-wide">
                                    Downloadon on the</p>
                                <h4 class="group-hover:text-black text-2xl">App Store</h4>
                            </div>
                        </a>
                        ...
                        <a href=""
                            ...
                            <div>
                                <p class="text-xs text-blackText group-hover:text-white font-light tracking-wide">
                                    Downloadon on the</p>
                                <h4 class="group-hover:text-white text-2xl">Play Store</h4>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="mx-6 md:mx-8 lg:mx-24 py-10 md:py-24">
            <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-6">
                <div class="space-y-4 md:space-y-8 order-2 md:order-1">
                    <div
                        class="flex justify-center items-center gap-x-2 bg-[#252525] text-white p-4 md:p-6 rounded-full w-full md:w-9/12 ml-0 md:ml-12">
                        ...
                        <div>
                            ...
                            <p class="text-xs whiteText font-extralight tracking-wide">Lorem ipsum dolor sit Obcaecati
                                quia nostrum,
                    ...
                    <div
                        class="flex justify-center items-center gap-x-2 bg-[#3d3d3d] text-white p-4 md:p-6 rounded-full w-full md:w-9/12">
                        <div class="w-8 h-8 md:w-24 md:h-24">
                            <img class="rounded-full" src="{{ asset('asset/images/customer1.jpg') }}"
                                alt="">
                        </div>
                ...
                <div class="space-y-4 md:space-y-8 order-1 md:order-2">
                    <h1 class="text-3xl md:text-5xl text-black font-semibold">What
